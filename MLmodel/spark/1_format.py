...
def save_to_parquet(data, filepath):
    """ Save the DataFrame to a Parquet file, compatible with Spark processing. """
    table = pa.Table.from_pandas(data)
    pq.write_table(table, filepath)

def main():
    # Load data
    filepath = '../filtered_datase.tsv'  # Adjust as needed
    ...
    save_to_parquet(df_train, 'train_data.parquet')
